...
function toCangqiongPlugin(compressed: Buffer): string {
    ...
    return [
        ...
        '            try { console.error("[packaging_and_shipping_plan] DecompressionStream unavailable"); } catch (e0) {}',
        '            return;',
        '        }',
        ...
        '        }).catch(function (err) {',
        '            try { console.error("[packaging_and_shipping_plan] inflate failed", err); } catch (e1) {}',
        '        });',
        '    }',
        '    function mount(html) {',
        '        var n = "__packaging_and_shipping_plan_root__";',
